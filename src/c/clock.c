...
static void set_colors() {
  ...
  GColor textcolor = app_config.inverted ? GColorBlack : COLOR_FALLBACK(GColorLightGray , GColorWhite);

  text_layer_set_background_color(s_time_layer, background);
  text_layer_set_text_color(s_time_layer, textcolor);

  text_layer_set_background_color(s_time_second_layer, background);
  text_layer_set_text_color(s_time_second_layer, textcolor);
...
static void set_fonts() {
  text_layer_set_font(s_time_second_layer, app_config.bold ? s_time_bold_font : s_time_font);
